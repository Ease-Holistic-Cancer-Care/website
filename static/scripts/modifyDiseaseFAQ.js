...
$("#disease_id").on('change', function () {
    ...
    var question_select = document.getElementById("faq_question_select");
...
$("#faq_question_select").on('change', function () {
    var id = $(this).find('option:selected').attr('id');
    var index = id.split('_')[2];
    document.getElementById("faq_question").value = questions[index];
